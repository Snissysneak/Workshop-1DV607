    ...
    public void subMenu(int choice) throws IOException {
        ...
        //SubMenu Boat
            ...
            if (val == 1) {
                ...
                System.out.println("To what member do you want to add the boat to? (enter Member ID)");
                //Verify given ID
                String owner = sc.next();
                while (!c_registryView.verifyID(owner)) {
                    owner = sc.next();
                }
        ...
        System.out.println("\nType 1 to go back to main menu. Anything else to quit ");
